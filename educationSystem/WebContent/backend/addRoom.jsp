...
<script type="text/javascript"	src="${pageContext.request.contextPath }/js/jquery.js"></script>
 <script type="text/javascript">
   function saveFun(){
	  ...
	  if(ma != "" && ma!= undefined){
		  ...
		  $.ajax({
			  ...
			  type : "post",
			  url : "${pageContext.request.contextPath }/adminLittleAction!selectRoomIfExist?roname="+ma,
			  success : function(msg) {
				  
				  if(msg=="yes"){//没有该教室,表单提交
					  $("#addForm").submit();
					  
				  }else{
					  
					  $("#manameErrror").html("已经存在该教室的相关信息，不可重复录入");
   ...
   function  moreFun(){
	   window.location.href="${pageContext.request.contextPath }/backend/addMoreRoom.jsp";
   }
...
<div class="container">
		...
		<div id="inner-bd">
			...
			<div class="button-group">
				<form id="addForm" action="${pageContext.request.contextPath }/adminLittleAction!addRoom" method="post">

					<table class="kv-table">
						<tbody>
						<tr>
								<td class="kv-label">请输入教室名称</td>
								<td class="kv-content" colspan="2">
								<input type="text" name="roname" id="maname"/>
