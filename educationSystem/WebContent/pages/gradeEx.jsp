...
<script type="text/javascript">
	...
	/* 	 $.ajax({
			type:"post",
			url:"${pageContext.request.contextPath}/teacherAction_selectExGrades?exid="+exid,
			async:false,
				...
				<div class="content">
					...
					<div class="fresh-datatables">
						<label> 课程：<span id="content"></span></label>
							<input type="button"onclick="search();" value="搜索" style="border-style: none; color: blue; border-radius: 20px; height: 35px; width: 50px;"><br>
						...
						<div  id="pw">
							...
							<div class="col-sm-7">
								<div class="dataTables_paginate paging_full_numbers"
									...
									<ul class="pagination">
									<li>第${pageGrade.currentPage}页 共${pageGrade.totalNum }条
								共${pageGrade.countPage}页
									</li>
