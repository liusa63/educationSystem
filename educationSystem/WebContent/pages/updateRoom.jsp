...
<body>
 ...
 <div class="container">
    <div class="table-zone">
      <form action="${pageContext.request.contextPath}/adminLittleAction!updateRoom" id="saveForm">
         <table class="no-data">
            <thead>
              <tr>
            ...
            <tr>
                ...
                <td><input type="hidden" name="roId" value="${room.roId }" >${room.roId }</td> 
                <td ><input type="text" name="roName" value="${room.roName }"></td>
              </tr>
