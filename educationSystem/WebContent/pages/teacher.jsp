...
<div class="wrapper">
    <div class="sidebar" data-color="orange" data-image="../../assets/img/full-screen-image-3.jpg">
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                <li>
                    <a href="${pageContext.request.contextPath}/teacherAction_findTeacher">
                ...
                <li>
                    ...
                    <div class="collapse" id="componentsExamples">
                        <ul class="nav">
                            <li><a href="${pageContext.request.contextPath}/teacherAction_findTeacherDetail">基本信息</a></li>
                            <li><a href="${pageContext.request.contextPath}/pages/teacherChangePwd.jsp">修改密码</a></li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="formsExamples">
                        <ul class="nav">
                            <li><a href="${pageContext.request.contextPath}/teacherAction_pageCourse">必修课表</a></li>
                            <li><a href="${pageContext.request.contextPath}/teacherAction_pageExcourse">选修课表</a></li>
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/teacherAction_pageEva">
                ...
                <li>
                   ...
                   <div class="collapse" id="mapsExamples">
                        <ul class="nav">
                            <li><a href="${pageContext.request.contextPath}/pages/teacherInputGrades.jsp">录入必修成绩</a></li>
                            <li><a href="${pageContext.request.contextPath}/teacherAction_pageGrades">查看必修成绩</a></li>
                            <li><a href="${pageContext.request.contextPath}/pages/teacherInputExcourse.jsp">录入选修成绩</a></li>
                            <li><a href="${pageContext.request.contextPath}/teacherAction_pageExGrades">查看选修成绩</a></li>
                        </ul>
                    </div>
