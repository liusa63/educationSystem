 ...
 //页面加载完成触发的事件
	$(function(){
		...
		$("#lr1").blur(function(){
			var u=$("#lr1").val();
			if(u==""){
				$("#lr1Error").html("教室名称不能为空");
			}
		});
		$("#lr2").blur(function(){
			var u=$("#lr2").val();
			if(u==""){
				$("#lr2Error").html("教室名称不能为空");
			}
		});
		$("#lr3").blur(function(){
			var u=$("#lr3").val();
			if(u==""){
				$("#lr3Error").html("教室名称不能为空");
			}
		});
	});
...
<div class="container">
		...
		<div id="inner-bd">
			...
			<div class="button-group">
                 ...
                 <form action="${pageContext.request.contextPath }/adminLittleAction!addMoreRoom" id="saveMoreForm" method="post">
					<table class="kv-table">
						<tbody>
						<tr>
								<td class="kv-label">请输入教室名称： （ 楼  教室门牌号）</td>
						</tr>
                        <tr>
