...
<div class="wrapper">
    <div class="sidebar" data-color="orange" data-image="../../assets/img/full-screen-image-3.jpg">
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                <li>
                    <a href="teacherAction_findTeacher">
                ...
                <li>
                    ...
                    <div class="collapse" id="componentsExamples">
                        <ul class="nav">
                            <li><a href="teacherAction_findTeacherDetail">基本信息</a></li>
                            <li><a href="${pageContext.request.contextPath}/pages/teacherChangePwd1.jsp">修改密码</a></li>
                        </ul>
                    </div>
                </li>
                <li> 
                    <a  href="teacherAction_selectSclass">
